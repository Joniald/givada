...
<div className="col-xl-3 mb-2">    
  <div className="card mr-5 ml-5" style={{ border: "none"}}>
     <img className="card-img bg-dark" src="https://i.ibb.co/bby41q5/Work01.png"   alt="Moto"/>
  </div>
  </div>
 <div className="col-xl-9" style={{ border: "none"}}>
  <div className="card-body m-3">
    ...
    <a href="#" class="btn btn-danger btn-round">Explore</a>
  </div>
 </div>
 </div>
...
<div className="col-xl-3 mb-2">    
  <div className="card mr-5 ml-5" style={{ border: "none"}}>
     <img className="card-img bg-dark"  src="https://i.ibb.co/Fn0TTXv/Work02.png"   alt="Moto"/>
  </div>
  </div>
 <div className="col-xl-9" style={{ border: "none"}}>
  <div className="card-body m-3">
